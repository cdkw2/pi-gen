...
6. By default, it will display the next 10 digits of π and update every second. You can modify the num_digits and update_interval parameters in the code to adjust the number of digits and the update interval.
